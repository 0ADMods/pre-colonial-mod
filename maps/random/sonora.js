...
const tPrimary = ["desert_dirt_rough", "desert_dirt_rough_2", "desert_sand_smooth"];
const tGrass = ["desert_dirt_rough", "desert_dirt_rocks_1", "desert_dirt_rocks_2", "desert_dirt_rough"];
const tForestFloor = "forestfloor_dirty";
const tGrassA = "desert_sand_smooth";
const tGrassB = "desert_dirt_rough_2";
const tGrassC = "desert_shore_stones";
const tGrassD = "desert_dirt_rough";
...
const oBerryBush = "gaia/flora_cactus_nopal";
const oDeer = "gaia/fauna_deer";
const oTurkey = "gaia/fauna_turkey";
...
g_Map.log("Creating cactus");
group = new SimpleGroup(
	[new SimpleObject(oCactusLarge, 5,7, 0,4)],
	true, clWater
);
createObjectGroupsDeprecated(group, 0,
...
group = new SimpleGroup(
	[new SimpleObject(oDeer, 2,5, 0,4)],
	true, clFood
);
createObjectGroupsDeprecated(group, 0,
	avoidClasses(clForest, 0, clPlayer, 10, clHill, 1, clFood, 20),
