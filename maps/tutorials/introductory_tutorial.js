Trigger.prototype.tutorialGoals = [
	...
	},
	{
		...
		{
			if (msg.unitTemplate != "units/mex_infantry_spearman_b" || +msg.count == 1)
			{
	...
	},
	{
		...
		"OnTrainingQueued": function(msg)
		{
			if (msg.unitTemplate != "units/mex_infantry_javelinist_b" || +msg.count == 1)
			{
				let cmpProductionQueue = Engine.QueryInterface(msg.trainerEntity, IID_ProductionQueue);
				cmpProductionQueue.ResetQueue();
				let txt = +msg.count == 1 ?
	...
	},
	{
		...
		"IsDone": function()
		{
			return TriggerHelper.HasDealtWithTech(this.playerID, "phase_town_mex");
		},
	...
	},
	{
		...
		"IsDone": function()
		{
			...
			return cmpTechnologyManager && cmpTechnologyManager.IsTechnologyResearched("phase_town_mex");
		},
		"OnResearchFinished": function(msg)
		{
			if (msg.tech == "phase_town_mex")
				this.NextGoal();
		}
	},
	{
		...
		"OnTrainingQueued": function(msg)
		{
			if (msg.unitTemplate != "units/mex_support_female_citizen" || +msg.count == 1)
			{
				let cmpProductionQueue = Engine.QueryInterface(msg.trainerEntity, IID_ProductionQueue);
				cmpProductionQueue.ResetQueue();
				let txt = +msg.count == 1 ?
	...
	},
	{
		...
		"OnTrainingQueued": function(msg)
		{
			if (msg.unitTemplate == "units/mex_siege_ram")
				++this.ramCount;
			if (this.IsDone())
			{
