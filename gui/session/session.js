...
function updatePlayerDisplay()
{
	...
	getGUIObjectByName("resourceWater").caption = playerState.resourceCounts.water;
...
function reportGame(extendedSimState)
{
	...
	for each (var player in extendedSimState.players)
	{
		...
		playerWaterGatheredString += player.statistics.resourcesGathered.water + ",";
		...
		playerWaterUsedString += player.statistics.resourcesUsed.water + ",";
		...
		playerWaterBoughtString += player.statistics.resourcesBought.water + ",";
		...
		playerWaterSoldString += player.statistics.resourcesSold.water + ",";
	...
	Engine.SendGameReport({
			...
			"waterUsed": playerWaterUsedString,
