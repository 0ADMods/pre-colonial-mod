...
var mercenaryCampGuards = {
	"generic/temperate": [
		{ "Template" : "structures/gaia_villager_huave" },
		{ "Template" : "units/huave_infantry_javelinist_e", "Count" : 4 },
		{ "Template" : "units/huave_infantry_javelinist_e", "Count" : 3 },
		{ "Template" : "units/huave_infantry_javelinist_e", "Count" : 4 },
		{ "Template" : "units/huave_infantry_javelinist_e", "Count" : 3 }
	],
	"generic/snowy": [
...
)
{
	...
	g_Map.placeEntityPassable(pickRandom(["structures/gaia_aqueduct_tower", "gaia/flora_tree_oak_new"]), 0, position, randomAngle());
...
var farmEntities = {
	"generic/temperate": { "building": "structures/mex_farmstead", "animal": "gaia/fauna_pig" },
	"generic/snowy": { "building": "structures/inca_farmstead", "animal": "gaia/fauna_sheep" },
	"generic/desert": { "building": "structures/hopi_farmstead", "animal": "gaia/fauna_camel" },
	"generic/alpine": { "building": "structures/inca_farmstead", "animal": "gaia/fauna_sheep" },
	"generic/mediterranean": { "building": "structures/zapo_farmstead", "animal": "gaia/fauna_pig" },
	"generic/savanna": { "building": "structures/zapo_farmstead", "animal": "gaia/fauna_horse" },
	"generic/tropic": { "building": "structures/mex_farmstead", "animal": "gaia/fauna_camel" },
	"generic/autumn": { "building": "structures/mex_farmstead", "animal": "gaia/fauna_horse" }
};
...
function placeCamp(position,
	...
	otherEntities = ["gaia/treasure/metal", "gaia/treasure/standing_stone",
		"units/mex_infantry_slinger_b", "units/mex_infantry_javelinist_b", "units/mex_infantry_slinger_b", "units/mex_infantry_javelinist_b", "units/mex_swordsman_e",
